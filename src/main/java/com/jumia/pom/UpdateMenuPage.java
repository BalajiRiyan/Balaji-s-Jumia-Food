...
public class UpdateMenuPage {
	...
	public void updateMenuToRestaurant(ExcelUtility eu,WebDriver driver,WebDriverUtiity wdu) throws EncryptedDocumentException, IOException
	{
		HashMap<String, String> map = eu.readMultipleDataFromExcel("UpdateMenu");
